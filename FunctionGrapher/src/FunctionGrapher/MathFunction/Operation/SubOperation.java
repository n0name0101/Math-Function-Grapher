 ...
 * @author noname
 */
public class SubOperation extends Number {
    private Number objLeftOperand;
    private Number objRightOperand;
    
    public SubOperation(Number _objLeftOperand , Number _objRightOperand){
        super(0.0);
        objLeftOperand = _objLeftOperand;
        objRightOperand =_objRightOperand;
    }
    
    public Number getobjRightOperand(){
        return objRightOperand;
    }
    
    public void setobjRightOperand(Number _objRightOperand){
        objRightOperand = _objRightOperand;
    }
